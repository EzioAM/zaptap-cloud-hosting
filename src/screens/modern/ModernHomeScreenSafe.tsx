...
import {
  QuickStatsWidgetEnhanced as QuickStatsWidget,
  QuickActionsWidgetEnhanced as QuickActionsWidget,
  RecentActivityWidgetEnhanced as RecentActivityWidget,
  FeaturedAutomationWidgetEnhanced as FeaturedAutomationWidget,
