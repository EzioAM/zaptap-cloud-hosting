-- Comprehensive Automation Sharing Database Schema for Zaptap (FIXED VERSION)
...
-- ============================================
-- 8. ENABLE REALTIME (FIXED)
-- ============================================
-- Note: These commands handle cases where tables might already be in the publication
-- If a table is already in the publication, the command will be skipped
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '✅ Sharing system database setup completed successfully!';
    RAISE NOTICE '';
    RAISE NOTICE 'Tables created/verified:';
    RAISE NOTICE '  - automations';
    RAISE NOTICE '  - deployments';
    RAISE NOTICE '  - public_shares';
    RAISE NOTICE '  - executions';
    RAISE NOTICE '  - sharing_logs';
    RAISE NOTICE '';
    RAISE NOTICE 'Next steps:';
    RAISE NOTICE '  1. Test sharing features in your app';
    RAISE NOTICE '  2. Run npm run setup:sharing to verify';
    RAISE NOTICE '  3. Monitor the executions table for usage';
END $$;