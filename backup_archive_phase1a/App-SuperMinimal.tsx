// SUPER MINIMAL TOUCH TEST - Absolute minimum to test touches
// This is the most basic possible React Native app to test if touches work
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>SUPER MINIMAL TOUCH TEST</Text>
        ...
        <Text style={styles.instruction}>
          If this counter doesn't increase when you tap,{'\n'}
          then touches are completely broken.
        </Text>
      </View>
    </SafeAreaView>
  );
