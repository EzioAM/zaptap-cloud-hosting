...
// CRITICAL FIX: Import gesture handler install for React Native 0.79.5
...
const FullApp: React.FC<{ store: any }> = React.memo(({ store }) => {
  ...
  return (
    // FIXED: GestureHandlerRootView with minimal configuration for proper touch handling
    <GestureHandlerRootView style={{ flex: 1 }}>
      {/* DIAGNOSTIC: Temporarily disabled SafeAppWrapper to test touch issues */}
